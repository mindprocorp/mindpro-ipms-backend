...
public class ManagerResponse {
    ...
    @Schema(description = "고객사 담당자 정보 응답 객체")
    @Builder
    public record CustomerManagerResponse(
            @Schema(description = "연결된 업무 일련번호 (고객/출원 등)", example = "CUST20260000001", format = "SEQ")
            String tblSeq,

            @Schema(description = "사무소 일련번호", example = "OFF20260001", format = "SEQ")
            String officeSeq,
