...
/**
 * @author : seokho
 * @fileName : DomesticDesignAppResponse.java
 * @since : 2026. 3. 3.
 */
public class DomesticDesignAppResponse {
    @Schema(description = "국내 디자인 출원 상세 응답")
    public record DesignAppDetailResponse(
            ...
            DesignDescription claimSummaryInfo,
        ...
        public static DesignAppDetailResponse fromVOViewDesign(
                CommonAppVO vo,
            ...
            return new DesignAppDetailResponse(
                    vo.getAppSeq(),
                    new CommonRecordResponse.CodeInfo(vo.getStatusCode(), vo.getStatusName()),
                    // 1. appCaseMng (DesignAppCaseMng)
                    new DesignAppCaseMng(
                    ...
                    // 2. appBaseInfo (DesignAppBaseInfo)
                    new DesignAppBaseInfo(
                    ...
                    // 3. appManagerInfo (DesignAppManagerInfo)
                    new DesignAppManagerInfo(
                            vo.getDeptName(),
                    ...
                    // 4. appCounterPartyInfo (DesignAppCounterPartyInfo)
                    new DesignAppCounterPartyInfo(
                            clientList,
                    ...
                    // 5. appNameInfo (DesignAppNameInfo)
                    new DesignAppNameInfo(
                            vo.getProposal(),
                            vo.getTitleKo(),
                            vo.getTitleEn(),
                            vo.getEtcTitle()
                    ...
                    // 6. appStrategy (DesignAppStrategy)
                    new DesignAppStrategy(
                    ...
                    // 7. claimSummaryInfo (DesignDescription)
                    new DesignDescription(
                            vo.getDesignDescription(),
                            vo.getDesignSummary()
                    ),

                    // 8. appManagement (DesignAppManagement)
                    new DesignAppManagement(
                            vo.getIsPoaSubmitted(),
                            vo.getIpcClassification(),
                            formatMinusHoursString8(vo.getEarlyPubRequestDate()),
                            vo.getIsPartialDesign(),
                    ...
                    // 9. appMaintenance (DesignAppMaintenance)
                    new DesignAppMaintenance(
                            vo.getMultiDesign(),
                            vo.getKipoDelayDays(),
                    ...
                    // 10. fileInfo (List<CommonRecordResponse.FileInfo>)
    ...
    public record DesignAppCaseMng(
            ...
            @Schema(description = "권리", example = "30")
