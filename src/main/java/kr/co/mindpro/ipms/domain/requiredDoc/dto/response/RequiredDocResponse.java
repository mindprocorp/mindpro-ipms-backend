package kr.co.mindpro.ipms.domain.requiredDoc.dto.response;
...
/**
 * @author : seokho
 * @fileName : RequiredDocResponse.java
 * @since : 2026. 4. 1.
 */
public class RequiredDocResponse {
    @Builder
    public record RequiredDocDetailResponse(
    ...
    @Builder
    public record RequiredDocListResponse(
            @Schema(description = "구비서류 시퀀스")
            String requiredDocSeq,
